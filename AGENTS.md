...
- `examples/web` — fullstack showcase: Hono backend (`web/server`) + Vite/React/
  shadcn/ai-elements client (`web/client`). See its AGENTS.md.
- `examples/plan-board` — todo/task showcase: a scripted planner
  ...
  approval gate. See its AGENTS.md.
...
- The `.Codex/skills/super-line` skill documents the super-line API — read it
